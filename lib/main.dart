        ...
        child: ListView(
          children: [
            Container(
              ...
              child: Image.asset("icon/cryptotrack.png"),
            ),
            ListTile(
            ...
            ListTile(
                ...
                onTap: () async{
                  String url = Uri.encodeFull
                    ("mailto:umerfarooqkhan325@gmail.com?subject=GetPass&body=Contact Reason: ");
            ...
            ListTile(
                ...
                onTap: () async{
                  String url ="https://play.google.com/store/apps/details?id=com.ukyz.cryptotrack";
                  if(await canLaunch(url)) {
                    await launch(url);
                  }
                }
                  ...
                  Expanded(child: Column(
                      ...
                      children: [
                        ...
                        Row(
                            children: [
                              FadeInImage(
                                  image: !blacklist.contains(widget.id)?NetworkImage
                                    ("https://static.coincap.io/assets/icons/${shortName
                                      .toLowerCase()}@2x.png"):AssetImage("icon/cryptotrack2.png"),
                                  placeholder: AssetImage("icon/cryptotrack2.png"),
